...
public class LoveCategoryAdapter extends RecyclerView.Adapter<LoveCategoryAdapter.ViewHolder> {
    ...
    public LoveCategoryAdapter(Context context) {
        this.context = context;
    }

    @NonNull
    @Override
    public LoveCategoryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull LoveCategoryAdapter.ViewHolder holder, int position) {
