...
public class PoojaBookedAdapter extends RecyclerView.Adapter<PoojaBookedAdapter.PoojaViewHolder> {
    ...
    public PoojaBookedAdapter(Context context) {
    ...
    public PoojaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_pooja_booked, parent, false);
